  ...
  return (
    <>
      ...
      <aside className={`
        ...
        bg-white border-r border-zinc-200 transition-transform duration-200
      ...
      `}>
        <div className="h-16 px-5 flex items-center justify-between border-b border-zinc-100">
          ...
          <button onClick={onClose} className="lg:hidden p-1.5 rounded-lg hover:bg-zinc-100 text-zinc-400 cursor-pointer">
            <IconX size={18} />
          </button>
        </div>
